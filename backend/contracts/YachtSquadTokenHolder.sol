...
contract YachtSquadTokenHolder is ERC1155Holder, Ownable {
     ...
     * @notice
     */
    function setYachtSquadTokenizationContract(
    ...
    function transferToken(address _to, uint256 _id, uint256 _amount) external {
        ...
        emit TokenTransfered(address(this),_to, _id, _amount);
    }
    ...
    function transferTokenBatch(
        ...
        require(
            msg.sender == yachtSquadTokenizationContract,
        ...
        for (uint256 i = 0; i < _ids.length; ++i) {
            require(
                ...
                "Insufficient token balance for id"
            );
            receivedTokens[_ids[i]].amount -= _amounts[i];
        }

        yachtTokenContract.safeBatchTransferFrom(
            address(this),
            _to,
            _ids,
            _amounts,
        ...
        emit TokenBatchTransfered(address(this),_to, _ids, _amounts);
    }
